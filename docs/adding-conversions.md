...
**`id`** — Stable identifier. Use lowercase with hyphens. Referenced by `--file-convert id`.
...
- Test from the terminal first: `dolphin-context-actions --file-convert your-id ~/testfile.ext`
