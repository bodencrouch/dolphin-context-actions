#!/usr/bin/env python3
"""General Dolphin file conversions driven by the bundled registry."""
...
CONFIG_DIR = Path.home() / ".config" / "dolphin-context-actions"
CONFIG_FILE = CONFIG_DIR / "conversions.yaml"
SYSTEM_REGISTRY = Path("/usr/share/dolphin-context-actions/conversions.yaml")
BUNDLED_REGISTRY = Path(__file__).with_name("conversions.yaml")
